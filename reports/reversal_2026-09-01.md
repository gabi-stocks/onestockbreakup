...
## QCOM  (2026-08-31)  close=170.48  RSI=55.5  [today so far: open 165.67 -> 166.43 (+0.46%) | DELAYED]
  ...
  [PASS] 2. Moving averages
         close>162.38(MA10) & >162.12(MA20)=True, MA10 rising=True, MA10>MA50=False
  [PASS] 3. MACD
         MACD=-2.03 vs Signal=-3.80 (above=True), hist=1.77 rising=True
  [PASS] 4. RSI
         RSI=55.47 rising=True, bullishDivergence=False
  [PASS] 5. Volume / RVOL
         day up=True, RVOL=1.28, up>downVol=True
