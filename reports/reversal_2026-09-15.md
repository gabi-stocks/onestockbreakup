...
## IBM  (2026-09-14)  close=249.09  RSI=60.8  [today so far: open 246.19 -> 247.84 (+0.67%) | DELAYED]
  ...
  [PASS] 2. Moving averages
         close>236.50(MA10) & >235.13(MA20)=True, MA10 rising=True, MA10>MA50=False
  [PASS] 3. MACD
         MACD=1.37 vs Signal=-0.32 (above=True), hist=1.69 rising=True
  [PASS] 4. RSI
         RSI=60.80 rising=True, bullishDivergence=False
  [----] 5. Volume / RVOL
         day up=False, RVOL=1.41, up>downVol=False
  [PASS] 6. Volume Profile POC
         close=249.09 vs POC=216.88 (above=True)
